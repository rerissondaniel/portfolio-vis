 ...
 * LEGENDA
 */
var desenhaLegendaDivergente = function(min, max, incremento, escalaDeCor, nomeVariavel){
  ...
  g.selectAll("rect")
  .data(d3.range(min,  max, incremento))
  .enter().append("rect")
    .attr("height", 8)
...
var desenhaLegendaLimiar = function(min, max, escalaDeCor, nomeVariavel){
  var x = d3.scaleLinear()
      .domain([min, max])
      .rangeRound([600, 860]);
